...
class TrackingNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('possession_center_tolerance_px', 40.0)
        self.declare_parameter('possession_row_px', 480.0)
        self.declare_parameter('possession_min_area', 18000.0)

...
class SoccerFSMNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('approach_curve_linear_breakaway_speed', 0.24)
        self.declare_parameter('approach_curve_linear_hold_speed', 0.14)
        ...
        self.declare_parameter('possession_turn_tolerance_px', 100.0)
        ...
        self.declare_parameter('visible_possession_confirm_max_err_x', 90.0)
        ...
        self.declare_parameter('visible_possession_deep_max_err_x', 70.0)
        ...
        self.declare_parameter('visible_possession_close_max_err_x', 25.0)

...
class SoccerFSMNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('ball_close_steer_band_px', 220.0)
        self.declare_parameter('ball_close_center_area', 4500.0)
        self.declare_parameter('ball_chase_crawl_threshold_px', 180.0)
        self.declare_parameter('ball_chase_crawl_speed', 0.06)
        self.declare_parameter('ball_close_steer_speed', 0.06)

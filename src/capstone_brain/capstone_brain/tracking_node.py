...
class TrackingNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('possession_center_tolerance_px', 140.0)
        self.declare_parameter('possession_row_px', 450.0)
        self.declare_parameter('possession_min_area', 11000.0)
